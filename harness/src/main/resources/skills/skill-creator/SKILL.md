...
When creating a new skill from scratch, manually create the skill directory and required files:
...
Only create the subdirectories that are actually needed for the skill.

Skip this step only if the skill being developed already exists and iteration is needed.
