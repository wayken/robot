      ...
      new Plugin({
        ...
        props: {
          decorations: ({ doc, selection }) => {
            ...
            const completionStorage = (this.editor.storage as any).completion
            const hasActiveCompletion = completionStorage && completionStorage.position >= 0
            ...
            doc.descendants((node, pos) => {
              ...
              if ((hasAnchor || !this.options.showOnlyCurrent) && isEmpty) {
                if (hasActiveCompletion && hasAnchor) {
